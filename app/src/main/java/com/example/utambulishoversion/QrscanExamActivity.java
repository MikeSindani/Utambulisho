...
public class QrscanExamActivity extends AppCompatActivity {
...
// and passing our context to it.
    private DBscanExamen dbscaninterro ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qrscan_exam);
    ...
    btnScanAdd = findViewById(R.id.scanexam_btn_Add);
    btnScanOpen = findViewById(R.id.scanexam_btn_open);
    btnViewinterroBack=findViewById(R.id.btn_scanexam_back);
    btnViewinterroLogo=findViewById(R.id.btn_scanexam_logo);
    btnViewInterrotxt=findViewById(R.id.txt_scanexam_text);
    ...
    // creating a new dbhandler class
    // and passing our context to it.
    dbscaninterro = new DBscanExamen(getApplicationContext());
        ...
        public void onClick(View v) {
            ...
            Intent i = new Intent(getApplicationContext(), ViewQrscanExamActivity.class);
