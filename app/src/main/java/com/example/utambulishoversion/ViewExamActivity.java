...
import com.example.utambulishoversion.database.DBHandlerExam;
...
public class ViewExamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnViewinterroBack=findViewById(R.id.btn_viewexamen_back);
        btnViewinterroLogo=findViewById(R.id.btn_viewexamen_logo);
        btnViewinterroScan=findViewById(R.id.btn_viewexamen_scan);
        btnViewInterrotxt=findViewById(R.id.txt_viewexamen_text);
        ...
        btnexport = findViewById(R.id.btn_xls_export_examen);
