...
public class DBscanExamen extends SQLiteOpenHelper {

    // creating a constant variables for our database.
    // below variable is for our database name.
    private static final String DB_NAME = "Examscandb";

    // below int is our database version
    private static final int DB_VERSION = 1;

    // below variable is for our table name.
    private static final String TABLE_NAME = "qrscanexam";
    ...
    public DBscanExamen(Context context) {
    ...
    // we have created a new method for reading all the courses.
    public ArrayList<QrscanExamenModal> readElementInterro(String courseName, String courseDescription, String courseTrack) {
        // on below line we are creating a
        // database for reading our database.
        SQLiteDatabase db = this.getReadableDatabase();
        ...
        // on below line we are creating a new array list.
        ArrayList<QrscanExamenModal> courseModalArrayList = new ArrayList<>();

        // moving our cursor to first position.
        if (cursorCourses.moveToFirst()) {
            do {
                // on below line we are adding the data from cursor to our array list.
                courseModalArrayList.add(new QrscanExamenModal(cursorCourses.getString(1),
                        ((Cursor) cursorCourses).getString(2),
                        cursorCourses.getString(4),
                        cursorCourses.getString(3)));
            } while (cursorCourses.moveToNext());
