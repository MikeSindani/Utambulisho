...
public class ViewQrscanInterroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_qrscan_interro);
        ...
        btnexport = findViewById(R.id.btn_xls_export);
